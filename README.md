...
**▶ [https://mori-akira.github.io/tank-simulator/](https://mori-akira.github.io/tank-simulator/)**

WASD で移動、マウスで砲塔を向け、左クリックで発射。`main` への push で自動更新される（`verify` が通ったときだけ公開される）。
